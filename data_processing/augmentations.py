...
class DataAugCifar10(tfkl.Layer):
    """Crop the image according to DirectPred implementation for CIFAR10.
    ...
    def call(self, x, s=1.0, batch_size=128):
        ...
        if random.random() < 0.8:
            ...
            x = tf.image.random_contrast(x,lower=0.4,upper=0.4)
            x = tf.image.random_saturation(x,lower=0.4,upper=0.4)
